...
def page1():
    ...
    if airbnb_data_rev is not None and booking_data_rev is not None:
        ...
        if airbnb_booking_data_rev is not None and charges_data_rev is not None:
            ...
            with kpi_col1:
                st.markdown(
                    f"<div style='border-radius: 50%; background-color: #006400; padding: 18px; text-align: center;'>"
            ...
            with kpi_col2:
                st.markdown(
                    f"<div style='border-radius: 50%; background-color: #FF0000; padding: 18px; text-align: center;'>"
            ...
            with kpi_col3:
                st.markdown(
                    f"<div style='border-radius: 50%; background-color: #db6635; padding: 18px; text-align: center;'>"
                    f"<i class='fas fa-sack-dollar' style='font-size: 30px; color: white;'></i><br>"
